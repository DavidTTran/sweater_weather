...
describe 'Google Places Image api' do
  it 'returns a picture with given picture reference id' do
    ...
    params = { key: ENV['GOOGLE_KEY'],
               photoreference: 'CmRaAAAAll6Qf2FtpCPCoaIfdK1kO_8yOQxpOdIehA5U1_o
               LQlwwYJc5ltpGrMJui8OafInwqfLNFIuYK84A5pIsqxNFcqsSFh9rpNM1bCH8O4
               bSUeYnF-ku8lzKnkdL_aVhg7azEhCJHTXNR18hzbhfk8rKqrGhGhT6L5ispm3SZ
               27Z9LbbO5ekesXq7w',
               maxwidth: 1080 }
